...
import VerifyEmailImage from '@app/assets/images/no_notifications.webp';
    ...
    <Auth.FormWrapper>
      <BaseForm layout="vertical" requiredMark="optional">
        ...
        <S.ContentWrapper>
          ...
          <Auth.FormTitle>{t('auth.securityCodeTitle')}</Auth.FormTitle>
          <S.VerifyEmailDescription>{t('auth.securityCodeDescription')}</S.VerifyEmailDescription>
