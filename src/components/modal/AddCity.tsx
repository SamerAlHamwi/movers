...
import { CreateCityModalProps } from './ModalProps';
...
export const AddCity: React.FC<CreateCityModalProps> = ({ visible, onCancel, onCreateCity, isLoading }) => {
        ...
        <BaseForm.Item style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '0' }}>
          <Space>
            ...
            <Button type="primary" style={{ height: 'auto' }} loading={isLoading} key="add" onClick={onOk}>
              <P1>{t('locations.addCityModalTitle')}</P1>
            </Button>
          </Space>
        </BaseForm.Item>
      }
