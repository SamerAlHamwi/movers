...
export const EditCompany: React.FC = () => {
  ...
  const [Dat, setDat] = useState<any[] | undefined>();
  ...
  console.log('ssssssssssssssssssssssssssss', test);
                  ...
                  subService?.tools?.length > 0
                    ? subService?.tools?.map((tool: any) => {
                        return {
                          ...
                          subServiceId: `${subService?.id}`,
                          toolId: `${tool?.id}`,
                          // test: `withTool service${service?.id} sub${subService?.id} tool${tool?.id}`,
                        };
                      })
                    : [],
