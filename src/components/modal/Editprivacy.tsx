...
import { CreateNotificationModalProps, EditNotifactionprops, Editprivacyprops } from './ModalProps';
...
export const Editprivacy: React.FC<Editprivacyprops> = ({ visible, onCancel, onEdit, Priv_values, isLoading }) => {
