...
import { EditRegionProps } from './ModalProps';
import { P1 } from '../common/typography/P1/P1';
import { useResponsive } from '@app/hooks/useResponsive';
import { FONT_SIZE } from '@app/styles/themes/constants';
import { RegionModel, LanguageType } from '@app/interfaces/interfaces';
import { LableText } from '../GeneralStyles';

export const EditRegion: React.FC<EditRegionProps> = ({ visible, onCancel, values, onEdit, isLoading }) => {
    ...
    <Modal
      ...
      title={
        <div style={{ fontSize: isDesktop || isTablet ? FONT_SIZE.xl : FONT_SIZE.lg }}>
          {t('locations.editRegionModalTitle')}
        </div>
      }
      onCancel={onCancel}
      maskClosable={true}
